...
if __name__ == "__main__":
    ...
    parser.add_argument("--restore_from", 
                        ...
                        # default="/mnt/d/ExtDM/logs_training/AE/KTH/kth/snapshots/RegionMM_0256_S050000.pth")
    parser.add_argument("--config_path", 
                        default="/mnt/d/ExtDM/config/AE/kth.yaml")
    parser.add_argument("--log_dir", 
                        default='/mnt/d/ExtDM/logs_validation/AE/KTH/KTH_test3')
    parser.add_argument("--data_dir", 
                        default="/mnt/d/ExtDM/data/KTH/mixed_processed")
