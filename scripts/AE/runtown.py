...
if __name__ == "__main__":
    ...
    # parser.add_argument("--config", default="e:/ExtDM/ExtDM/config/AE/kth.yaml", help="path to config")
    # parser.add_argument("--log_dir",default='e:/ExtDM/ExtDM/logs_training/AE/KTH', help="path to log into")
    ...
    parser.add_argument("--log_dir", default='/mnt/d/ExtDM/logs_training/AE/KTH_NEW', help="path to log into")
    parser.add_argument("--checkpoint",  # use the pretrained Taichi model provided by Snap
                        default="/mnt/d/ExtDM/logs_training/AE/KTH/kth/snapshots/RegionMM_0256_S050384.pth", help="path to checkpoint to r"
                                         ""
                                         "estore")
    parser.add_argument("--device_ids", default="6,7,8,9", type=lambda x: list(map(int, x.split(','))),
                        help="Names of the devices comma separated.")
    ...
    mp.spawn(train, args=(world_size, config, dataset_params, train_params, generator, region_predictor, bg_predictor, log_dir, args.checkpoint, args.device_ids), nprocs=world_size, join=True)