...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir",default="/mnt/d/ExtDM/logs_training/DM/KTH_new62", help="path to log into")
    parser.add_argument("--config",default="/mnt/d/ExtDM/config/DM/kth.yaml",help="path to config")
    parser.add_argument("--device_ids", default="cuda:7,cuda:8", type=lambda x: list(map(str, x.split(','))),
                        help="Names of the devices comma separated.")
    parser.add_argument("--random-seed", type=int, default=1234,
                        help="Random seed to have reproducible results.")
    # parser.add_argument("--checkpoint", default="/mnt/d/ExtDM/logs_training/DM/KTH_new/kth_test/snapshots/flowdiff_0004_S035000.pth")
    parser.add_argument("--checkpoint",
                        default="/mnt/d/ExtDM/logs_training/DM/KTH_new5/kth_test/snapshots/flowdiff_0004_S120000.pth")
    ...
    parser.add_argument("--path", default=0,type=int,help="0 is use Original Time  Attention, "
