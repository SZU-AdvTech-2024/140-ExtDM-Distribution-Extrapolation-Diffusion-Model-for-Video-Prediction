...
def default_opener(p_):
    return h5py.File(p_, 'r')
...
if __name__ == "__main__":
    ...
    # Make
    h5_maker = HDF5Maker('EXPERIMENTS/h5', num_per_shard=10, force=True, video=True)

    a = [torch.zeros(60, 3, 64, 64)] * 20
    for data in a:
